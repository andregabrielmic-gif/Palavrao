...
    saveCurrentState();
    
    activeMode = newMode; // Define o novo modo ativo
...
            }, 1000); 
            
            // --- CORREÇÃO 2: Adicionado 'return' para parar o fluxo após vitória ---
            return;
        }
...
    const state = gameState[activeMode];
    ...
    // --- CORREÇÃO 1: Garante que nada possa ser digitado após vitória ---
...
    
    // --- CORREÇÃO 3: Removido bloco que resetava stats.keyboardStates.
    // stats.keyboardStates = { solo: {}, dueto: {}, quarteto: {} };
    // O getInitialStats já carrega ou inicializa corretamente.
